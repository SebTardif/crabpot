...
- **Last dashboard update:** Sep 10, 2026, 06:03 UTC
...
- **GitHub report run:** [34441975573](https://github.com/openclaw/crabpot/actions/runs/34441975573)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2387ms / p95 2387ms / plugin delta RSS 1.2MB / plugin delta CPU 0ms / OpenClaw import 101.5ms / activate 0.4ms |
| Runtime profile        | p50 6279ms / command p95 6536ms / max RSS 217.9MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 101.5ms | 103.7ms |
